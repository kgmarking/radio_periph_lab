...
int main()
{
    ...
    init_platform();
    print("\r\n\r\n\r\nLab 7 Kurt Marking - Custom Peripheral Demonstration\n\r");
    ...
    throughput = (float) (stop_time - start_time) / 125000000; // seconds elapsed
    throughput = (32 * 2048 / 8) / throughput; // bytes per second
    throughput = throughput / (1024 * 1024); // MB per second
