...
#define RADIO_TUNER_FAKE_ADC_PINC_REG_OFFSET 0
#define RADIO_TUNER_TUNER_PINC_REG_OFFSET 4
#define RADIO_TUNER_CONTROL_REG_OFFSET 8
#define RADIO_TUNER_TIMER_REG_OFFSET 12
